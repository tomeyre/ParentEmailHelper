...
public class RequestParentMail {
    ...
    ParentMailSession parentMailSession = ParentMailSession.getInstance();
    ...
    public String getJSONFromUrlUsingGet(String url) {
        ...
        try {
            ...
            restConnection.setRequestProperty("Cache-Control", "no-cache");
            restConnection.setRequestProperty("Connection", "keep-alive");
            restConnection.setRequestProperty("Host", "pmx.parentmail.co.uk");
            restConnection.setRequestProperty("Pragma", "no-cache");
            if (parentMailSession.getReferer() != null) {
                restConnection.setRequestProperty("Referer", parentMailSession.getReferer());
            }
            ...
            switch (status) {
                ...
                case 201:
                    ...
                    BufferedReader br = new BufferedReader(new InputStreamReader(new GZIPInputStream(restConnection.getInputStream())));
                    ...
                    parentMailSession.setReferer(url);
